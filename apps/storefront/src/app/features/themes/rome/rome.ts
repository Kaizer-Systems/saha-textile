...
@Component({
	...
	styleUrls: ['./rome.scss'],
	imports: [HomeBanner, Title, Categorie, Banner, Product, ImageLink, FourColumnProduct, Blog, Newsletter],
})
export class Rome {
	...
	categoryProduct$: Observable<IProductModel | undefined> = toObservable(computed(() => this.productsQuery.data()));
