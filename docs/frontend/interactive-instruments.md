...
| 4   | **[Schema Nebula](/database/schema-nebula)** ✅ live               | The 64 explicit target collections as a zoomable star map; eight exact-name solid stars and 56 ghosts. It remains distinct from the scaffolded source-generated catalogue of all 32 current models.                                        | **Built** |
