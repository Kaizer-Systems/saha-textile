...
@Component({
	...
	imports: [Button, ReactiveFormsModule, FormsModule, TranslocoModule],
})
export class NewsletterModal {
	...
	newsletter$: Observable<boolean> = toObservable(this.siteConfigStore.newsletter);
	...
	ngAfterViewInit(): void {
		if (this.newsletter === true) {
			...
			this.siteConfigStore.updateSession('newsletter', false);
		}
	}
