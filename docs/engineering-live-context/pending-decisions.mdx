...
## 25. `DEC-ACCOUNT-EMPTY-TILES` — Wallet / points / orders tiles on the account dashboard
...
## 26. `DEC-SOFT-DELETED-IDENTITY-REUSE` — Provider links on a soft-deleted customer
...
## 27. `DEC-DENVER-HOME-GRADIENT` — Home-search background ramp
