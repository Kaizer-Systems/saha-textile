...
| 4   | **[Schema Nebula](/database/schema-nebula)** ✅ live               | The 64 explicit target collections as a zoomable star map; seven solid stars = existing models, 57 ghosts = target-only; cluster lenses, relationship lines and evidence expose architecture without claiming the deferred field catalogue exists. | **Built** |
