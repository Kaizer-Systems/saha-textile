...
- The locked child-transition metaphors are:
    ...
    - MongoDB catalogue — **Schema Observatory**: a telescope resolves the seven implemented model constellations from source evidence.
...
- Each bridge and transition owns an independent symbolic language:
    ...
    - Schema Observatory uses a mechanical dome and telescope, optical model acquisition, seven-model evidence resolution, and catalogue projection.
