...
- **Release blocker:** the portal must not be deployed until access control protects the entire host, including HTML, JavaScript/CSS/assets, search payloads, Engineering Live Context, Storybook, Scalar, TypeDoc, and future database-catalogue output.
