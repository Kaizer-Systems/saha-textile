...
| Authentication      | Cookie-session gateway, guarded work shells, password/PIN/recovery state, API authorization, first-admin operator bootstrap and role/authority APIs exist | Scaffolded  | Security Settings, idle soft lock, browser PIN proof and management-screen adoption remain open. |
