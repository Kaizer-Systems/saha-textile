...
Do not describe this as a server cart. IDs and totals can still originate from client mock behavior, and authoritative price/stock validation belongs to the backend.
